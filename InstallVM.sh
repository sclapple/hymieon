...
install_main() {
    ...
    yay -S --needed --noconfirm \
        ...
        cronie git openssh power-profiles-daemon \
...
# Main flow
echo -e "${YELLOW}This script will configure your system with Hyprland/Noctalia (VM version, no greetd).${NC}"
echo -e "${YELLOW}After reboot, start Hyprland with: Hyprland${NC}"
