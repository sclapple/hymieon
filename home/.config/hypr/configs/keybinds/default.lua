...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(Apps.files), {
...
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("kitty --class yazi-configs -- yazi .config/hypr/"), {
  desc = "Browse config files",
})

-- gamemode
hl.bind(mainMod .. " + SHIFT + G", toggle_gamemode, {
...
hl.bind(mainMod .. " + SHIFT + F", hl.dsp.window.fullscreen_state({ internal = "2", client = "2", action = "toggle" }), {
  desc = "Toggle fullscreen window",
})
hl.bind(mainMod .. " + SPACE", hl.dsp.window.float({ action = "toggle" }), {
  desc = "Toggle floating for active window",
})
...
hl.bind(mainMod .. " + ALT + B", hl.dsp.exec_cmd("noctalia msg bar-toggle"), {
  desc = "Toggle Bar",
})
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("noctalia msg screenshot-region"), {
  desc = "Screenshot",
})
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("kitty --class yazi-configs -- yazi .config/noctalia/"), {
  desc = "Browse noctalia configs",
})
hl.bind(mainMod .. " + SHIFT + O", hl.dsp.exec_cmd("noctalia msg settings-toggle"), {
  desc = "Toggle Noctalia settings",
})
hl.bind(mainMod .. " + ALT + K", hl.dsp.exec_cmd('noctalia msg panel-toggle launcher "/binds"'), {
  desc = "Keybind browser",
})

-- workspaces
hl.bind("ALT + SHIFT + TAB", hl.dsp.focus({ workspace = "previous" }), {
  desc = "Swap to last workspace",
})
hl.bind("ALT + TAB", hl.dsp.exec_cmd("snappy-switcher next --mod alt"), {
  desc = "Cycle through windows on the same workspace",
})
