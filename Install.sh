...
install_main() {
  ...
  paru -S --needed --noconfirm \
    ...
    git openssh greetd power-profiles-daemon \
    grim cliphist wl-clip-persist \
    gamescope mangohud gamemode \
    brightnessctl ddcutil goverlay \
    pipewire \
    fish kitty starship fzf fd ripgrep jq yazi \
    less fastfetch fisher \
    neovim opencode \
    jre8-openjdk \
